...
+ (NSString*)getFriendlyDateString:(NSString*)dateString{
    NSDate* date = [NSDate dateFromString:dateString];
    date = [NSDate getNowDateFromatAnDate:date];
    NSTimeInterval theDiff = -date.timeIntervalSinceNow;
    NSString* output = @"";
    if(theDiff < 60){
        output = @"刚刚";
